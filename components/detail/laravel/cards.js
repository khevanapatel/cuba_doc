	...
	return(
		<div className="card-body">
	        ...
	        <ul className="nav nav-tabs" id="myTab8" role="tablist">
	          <li className="nav-item"><a className={`nav-link ${(active=='basic-card')? 'active' : ''}`} data-bs-toggle="tab" url="#basic-card" role="tab" aria-selected="true" data-original-title="" title="" onClick={()=>setActive('basic-card')}>Basic Cards</a></li>
