	...
	return(
		<div className="card-body">
            ...
            <ul className="nav nav-tabs" id="myTab4" role="tablist">
              ...
              <li className="nav-item"><a className={`nav-link ${(active=='treeview') ? 'active' : ''}`} data-bs-toggle="tab" url="#treeview" role="tab" aria-selected="false" data-original-title="" title="" onClick={()=>setActive('treeview')}>Treeview</a></li>
              <li className="nav-item"><a className={`nav-link ${(active=='owlcomponent') ? 'active' : ''}`} data-bs-toggle="tab" url="#owlcomponent" role="tab" aria-selected="false" data-original-title="" title="" onClick={()=>setActive('owlcomponent')}>Owl Carousel</a></li>
            ...
            <div className="tab-content" id="myTabContent4">
              <div className={`tab-pane fade ${(active=='scrollable') ? 'show active' : ''}`} id="scrollable" role="tabpanel">
                <p className="pt-4 pb-2">This is an Angular wrapper library for the Perfect Scrollbar. To use this library you should get familiar with the Perfect Scrollbar documentation as well since this documentation only explains details specific to this wrapper.</p><b>Installing and usage</b>
                <div className="mb-4">
                  <CopyToClipboard
                  	id="scrollablecode"
                  ...
                  />
                 <a className="btn btn-solid" href="https://www.npmjs.com/package/ngx-perfect-scrollbar" target="_blank"> Supplemental </a>
                </div>
              </div>
              <div className={`tab-pane fade ${(active=='treeview') ? 'show active' : ''}`} id="treeview" role="tabpanel">
                ...
                <div className="mb-4">
                  ...
                  />
                  <a className="btn btn-solid" href="https://www.npmjs.com/package/ngx-treeview" target="_blank"> Supplemental </a>
                </div>
              </div>
              <div className={`tab-pane fade ${(active=='owlcomponent') ? 'show active' : ''}`} id="owlcomponent" role="tabpanel">
                <p className="pt-4"><b>Installing and usage</b></p>
                <div className="mb-4">
                  <CopyToClipboard
                    id="owlcode"
                  ...
                  /> 
                  <a className="btn btn-solid" href="https://www.npmjs.com/package/ngx-owl-carousel-o" target="_blank"> Supplemental </a>
                </div>
              </div>
              ...
              <div className={`tab-pane fade ${(active=='rating') ? 'show active' : ''}`} id="rating" role="tabpanel">
                <p className="pt-4"><b>Installing and usage</b></p>
                 <CopyToClipboard
                  ...
                  /> 
                  <a className="btn btn-solid" href="https://ng-bootstrap.github.io/#/components/rating/api" target="_blank"> Supplemental </a>
              </div>
              <div className={`tab-pane fade ${(active=='sweetalert') ? 'show active' : ''}`} id="sweetalert" role="tabpanel">
                ...
                <div className="mb-4">
                  ...
                  <CopyToClipboard
                    id="sweetalertcode1"
                    text={` \n <div className="card-body btn-showcase">\n\n   <button type="button" className="btn btn-primary" (click)="basicAlert()">Basic</button>\n\n </div>`}
                  /> 
                  <CopyToClipboard
                    id="sweetalertcode2"
                    text={`\n /* ES6 Modules or TypeScript */ \n\n import Swal from 'sweetalert2'\n\n \n\n /* CommonJS*/ \n\n const Swal = require('sweetalert2')\n\n ...\n\n /*method call */ \n\n basicAlert()\n {\n\n Swal.fire('Any fool can use a computer')\n\n }`}
                  /> 
                  <a className="btn btn-solid" href="https://www.npmjs.com/package/angular-sweetalert-2" target="_blank"> Supplemental </a>
                </div>
              </div>
            </div>
            ...
            <div className="tab-content" id="myTabContent5">
              <div className={`tab-pane fade ${(activeAE == 'range-slider') ? 'show active' : ''}`} id="range-slider" role="tabpanel">
                ...
                <div className="mb-4">
                  ...
                  /> 
                  <a className="btn btn-solid" href="https://www.npmjs.com/package/ng5-slider" target="_blank"> Supplemental </a>
                </div>
              </div>
              <div className={`tab-pane fade ${(activeAE == 'image-cropper') ? 'show active' : ''}`} id="image-cropper" role="tabpanel">
                ...
                <div className="mb-4">
                  ...
                  /> 
                  <a className="btn btn-solid" href="https://www.npmjs.com/package/ngx-image-cropper" target="_blank"> Supplemental </a>
                </div>
              </div>
              <div className={`tab-pane fade ${(activeAE == 'imageupload') ? 'show active' : ''}`} id="imageupload" role="tabpanel">
                ...
                <div className="mb-4">
                  ...
                  <CopyToClipboard
                    id="uploadcode1"
                    text={`\n <div className="card-body">\n\n <div className="dropzone dropzone-primary" [dropzone]="config1" (error)="onUploadError($event)" (success)="onUploadSuccess($event)">\n\n <div className="dz-message needsclick">\n\n ............\n\n </div>\n\n </div>\n\n </div>\n`}
                  /> 
                  ...
                  /> 
                  <a className="btn btn-solid" href="https://www.npmjs.com/package/ngx-dropzone-wrapper" target="_blank"> Supplemental </a>
                </div>
              </div>
            </div>
        </div>
