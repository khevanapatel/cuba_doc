	                  ...
	                  <li>1. Run the CLI command react create and provide the name my-app, as shown here:
	                    <div className="py-2 ps-3">
	                      <div className="code-box-copy">
	                        ...
	                        <pre><code className="language-html" id="createcode1">npm create-react-app my-app</code></pre>
	                      </div>
	                    </div>
	                  </li>
	                  ...
	                  <li>1. Go to the workspace folder (my-app).
	                    <div className="py-2 ps-3">
	                      <div className="code-box-copy">
	                        ...
	                        <pre><code className="language-html" id="cdcode">cd my-app</code></pre>
	                      </div>
	                    </div>
	                  </li>
	                  <li>2. Launch the server by using the CLI command npm start
	                    <div className="py-2 ps-3">
	                      <div className="code-box-copy">
	                        ...
	                        <pre><code className="language-html" id="npmcode">npm start</code></pre>
	                      </div>
	                    </div>
	                  </li>
	                ...
	                <ul>
	                  <li>Install React CLI Using:
	                    <div className="code-box-copy">
	                      ...
	                      <pre><code className="language-html" id="installcode2">npm install -g create-react-app</code></pre>
	                    </div>
	                  </li>
	                </ul>
	                  ...
	                  <li>2) Extract it and then go in to theme folder.
	                    <div className="py-2 ps-3">
	                      <div className="code-box-copy">
	                        ...
	                        <pre><code className="language-html" id="cdcode2">cd theme</code></pre>
	                      </div>
	                    </div>
	                  </li>
	                  <li>3)  Import all dependency by installing npm command
	                    <div className="py-2 ps-3">
	                      <div className="code-box-copy">
	                        ...
	                        <pre><code className="language-html" id="npmcode2">npm install</code></pre>
	                      </div>
	                    </div>
	                  </li>
	                  <li>4)  Now you are in stage to successfully run Cuba using below command:
	                    <div className="py-2 ps-3">
	                      <div className="code-box-copy">
	                        ...
	                        <pre><code className="language-html" id="npmcode3">npm start</code></pre>
	                      </div>
	                        ...
	                        <li>1. Build you application for host on server using below command:
	                          <div className="py-2 ps-3">
	                            <div className="code-box-copy">
	                              ...
	                              <pre><code className="language-html" id="buildcode1">npm run build</code></pre>
	                            </div>
	                          </div>
	                        </li>
	                        <li>2. It will create one dist file in your theme folder. Make zip of dist folder. so here you are ready to upload your theme on server.
	                          ...
	                          <div className="py-2 ps-3">
	                            <div className="code-box-copy">
	                              ...
	                              <pre><code className="language-html" id="buildcode2">
	                              Options -MultiViews
	                              RewriteEngine On
	                              {aa}
